...
calcularMedia = lambda nota1, nota2: sum([nota1, nota2]) / len([nota1, nota2])
print(calcularMedia(8, 10))
print(calcularMedia(6, 7))

dobroLambda = lambda num: num * 2
print(dobroLambda(5))
...
def configurarCaptura(**opcs):
    ...
    qualidade = opcs.get("qualidade", "media")
    flash = opcs.get("flash", True)
    return modo, qualidade, flash

print(configurarCaptura(modo="noturno"))
print(configurarCaptura(modo="noturno", qualidade="media", flash=False))
